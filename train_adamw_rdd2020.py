...
_MODEL = r'D:\phd_yolo\runs\rdd2020\adamw_2025-06-27-02-28_train\weights\last.pt'
_DATASET = r'.\data\rdd2020.yaml'
_OPTIMIZER = 'AdamW'
...
if __name__ == '__main__':
    ...
    #################### Train
    model = YOLO(_MODEL)
    run_name = f'adamw_{now}_train'
    results = model.train(
        data=r'.\data\rdd2020.yaml',
        epochs=20,
        imgsz=600,
        batch=8,
    ...
    # Output dir
    run_name = _DIR_BASE + _PROJECT + "/" + f'adamw_{now}_test'
